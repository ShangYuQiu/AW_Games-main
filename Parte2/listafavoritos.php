...
$tituloPagina = 'Lista de favoritos';
...
if(isset($_SESSION["login"])){
  ...
  $gm=Usuariofav::getJuegoFavoritos($us->getId());
  $tamaño = count($gm);
  if($tamaño>2){
...
$contenidoPrincipal .= <<<EOS
    <div class = "games_basic">
              <span id = "games_info"> 
                  <div id = "title">Lista de juegos favoritos</div>
              </span>
        </div>
...
EOS;
    ...
    $formF = new FormEraseJuegoFav($juegoId);
    $htmlFormBorrar = $formF->gestiona();
